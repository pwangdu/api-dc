...
import in.disruptech.platform.config.Constants;
import in.disruptech.platform.domain.Authority;
import in.disruptech.platform.domain.PersistentToken;
import in.disruptech.platform.domain.User;
import in.disruptech.platform.repository.AuthorityRepository;
import in.disruptech.platform.repository.PersistentTokenRepository;
import in.disruptech.platform.repository.UserRepository;
import in.disruptech.platform.security.AuthoritiesConstants;
import in.disruptech.platform.service.MailService;
import in.disruptech.platform.service.UserService;
import in.disruptech.platform.service.dto.PasswordChangeDTO;
import in.disruptech.platform.service.dto.UserDTO;
import in.disruptech.platform.web.rest.errors.ExceptionTranslator;
import in.disruptech.platform.web.rest.vm.KeyAndPasswordVM;
import in.disruptech.platform.web.rest.vm.ManagedUserVM;
