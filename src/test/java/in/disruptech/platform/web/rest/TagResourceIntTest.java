...
import in.disruptech.platform.repository.TagRepository;
import in.disruptech.platform.repository.search.TagSearchRepository;
...
public class TagResourceIntTest {
    ...
    private static final Double DEFAULT_REMAINING_BATTERY = 1D;
    private static final Double UPDATED_REMAINING_BATTERY = 2D;
     ...
     *
     * @see in.disruptech.platform.repository.search.TagSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Tag createEntity(EntityManager em) {
        Tag tag = new Tag()
            ...
            .remainingBattery(DEFAULT_REMAINING_BATTERY);
        return tag;
    }
    ...
    public void createTag() throws Exception {
        ...
        assertThat(testTag.getTagId()).isEqualTo(DEFAULT_TAG_ID);
        assertThat(testTag.getRemainingBattery()).isEqualTo(DEFAULT_REMAINING_BATTERY);
    ...
    public void getAllTags() throws Exception {
        ...
        restTagMockMvc.perform(get("/api/tags?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].remainingBattery").value(hasItem(DEFAULT_REMAINING_BATTERY.doubleValue())));
    }
    ...
    public void getTag() throws Exception {
        ...
        restTagMockMvc.perform(get("/api/tags/{id}", tag.getId()))
            ...
            .andExpect(jsonPath("$.remainingBattery").value(DEFAULT_REMAINING_BATTERY.doubleValue()));
    }
    ...
    public void updateTag() throws Exception {
        ...
        updatedTag
            ...
            .remainingBattery(UPDATED_REMAINING_BATTERY);
        ...
        Tag testTag = tagList.get(tagList.size() - 1);
        assertThat(testTag.getTagId()).isEqualTo(UPDATED_TAG_ID);
        assertThat(testTag.getRemainingBattery()).isEqualTo(UPDATED_REMAINING_BATTERY);
    ...
    public void searchTag() throws Exception {
        // Initialize the database
        tagRepository.saveAndFlush(tag);
        when(mockTagSearchRepository.search(queryStringQuery("id:" + tag.getId())))
