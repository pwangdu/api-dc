...
/**
 * Performance test for the Membership entity.
 */
class MembershipGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Membership entity")
        ...
        .repeat(2) {
            ...
            .exec(http("Delete created membership")
            .delete("${new_membership_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
