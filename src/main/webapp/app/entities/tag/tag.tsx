...
import { getSearchEntities, getEntities } from './tag.reducer';
...
export class Tag extends React.Component<ITagProps, ITagState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="tag-heading">
          <Translate contentKey="platformApp.tag.home.title">Tags</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="platformApp.tag.home.createLabel">Create new Tag</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('platformApp.tag.home.search')}
                  />
